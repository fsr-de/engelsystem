...
return [
    ...
    'oauth'                   => [
        ...
        'engelsystem' => [
            ...
            // Authentication URL
            'url_auth' => env('OIDC_AUTH_URL', ''),
            // Token URL
            'url_token' => env('OIDC_TOKEN_URL', ''),
            ...
            'username' => env('OIDC_USERNAME_CLAIM', 'nickname'),
            ...
            'mark_arrived' => (bool) env('OIDC_MARK_ARRIVED', 'false'),
            ...
            'allow_registration' => (bool) env('OIDC_ALLOW_REGISTRATION', 'false'),
            // Auto join teams
