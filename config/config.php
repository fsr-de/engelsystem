...
// keys and passwords are redacted. Search for "<COMPLETE>" to find their places
...
return [
    ...
    'footer_items'            => [
        ...
        'Contact' => env('CONTACT_EMAIL', 'mailto:fachschaftsrat@hpi.de'),
    ],
    ...
    'email'                   => [
        ...
        'from'   => [
            ...
            'address' => env('MAIL_FROM_ADDRESS', 'noreply@myhpi.de'),
    ...
    'oauth'                   => [
        ...
        'engelsystem' => [
            ...
            // Authentication URL
            'url_auth' => 'https://oidc.hpi.de/auth',
            // Token URL
            'url_token' => 'https://oidc.hpi.de/token',
            // User info URL which provides userdata
            'url_info' => 'https://oidc.hpi.de/me',
    ...
    'last_unsubscribe'        => env('LAST_UNSUBSCRIBE', 48),
    ...
    'max_freeloadable_shifts' => env('MAX_FREELOADABLE_SHIFTS', 20),
